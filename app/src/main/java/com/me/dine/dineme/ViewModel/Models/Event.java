...
public class Event {
    ...
    public Event(String groupName, String name, String description, Date date, String imageUrl, int stars, int starVotes, int minReservation, int maxReservation, String foods) {
